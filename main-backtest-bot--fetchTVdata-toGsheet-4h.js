...
async function start() {
  ...
  const id = "ap6ms284yb_replace_fdcbbatbysp";
const certificate = "v2:T9DQ1lP_replace_mKi0E94nts=";
const spreadsheetId = "1NJDfQ9ef5ubG5i_replace_lYiZq7SbG9SUe3VZBtp8";

  for (const coin of markets) {
    const coinbybit = coin;
    const sheetTitle = coinbybit + 'USDT034';
    ...
    const sheetTitleR = coinbybit + 'R-USDT034';
